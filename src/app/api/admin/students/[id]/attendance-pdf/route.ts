...
// GET /api/admin/students/[id]/attendance-pdf?month=YYYY-MM
// Generates a PDF report with the monthly attendance summary for any student.
// Admin-only access. Token accepted via Authorization header OR ?token= (for window.open).
export async function GET(
  ...
  // Auth: header or query param (matches carnet-pdf pattern)
